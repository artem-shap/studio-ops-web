...
const work = [
  ...
  },
  {
    ...
    title: "A store rebuilt around its checkout",
    body: "Half of the people who reached payment never finished. We rebuilt the store template by template, kept every URL, and cut the last three steps down to one.",
    caption: "Page templates in flow order. The rebuilt version runs at right.",
